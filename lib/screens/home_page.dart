          ...
          Container(
            decoration: const BoxDecoration(
              gradient: RadialGradient(
                colors: [
                  Color(0xFF484263), // Warna cerah di tengah
                  Color(0xff060908), // Warna gelap di luar
                ],
                center:
                    Alignment.centerRight, // Titik pusat gradien di kanan atas
                radius: 1.0, // Mengontrol seberapa jauh gradien menyebar
              ),
            ),
          ),
          SafeArea(
              ...
              child: Column(
                ...
                children: [
                  ...
                  const CarItem(
                    ...
                    price: "1.400.000",
                    assetPath: "assets/images/fourtuner.png",
                    brand: 'Toyota',
                  ),
                ],
              ),
